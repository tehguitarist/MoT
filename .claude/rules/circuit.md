...
| Stage 1 feedback floor | Yellow **R2∥R3 ≈ 990 Ω**, Red **R2 = 100k** | Stage 1 | SW1B Hi-Gain switch: stock = R2∥R3, Hi-Gain = R2. Floor + DRIVE = Z_upper resistive leg |
| DRIVE pot | 100kB linear | Stage 1 | 2-terminal rheostat in Z_upper; floor+DRIVE = 0.99k–100k (Yellow) / 100k–200k (Red) |
...
- **Stage-1 floor: Yellow R2∥R3 ≈ 990Ω, Red R2 = 100k.** The SW1B Hi-Gain switch (Red only,
  fixed mod) parallels R3(1k) onto R2(100k). Stock (Yellow) runs the low ~1k floor → nearly-clean
  minimum; Hi-Gain (Red) lifts the whole DRIVE range up ("9 o'clock acts like noon"). Parts-list
  confirmed (Theseus p29).
...
IC_A (non-inverting, no PolarityInverterT): pin3(+)=in, pin2(−)=NodeF, pin1=NodeG=out
  ...
  Z_upper (NodeF→NodeG): (floor + DRIVE 0–100k) ∥ C2(100pF)   [floor = 990Ω Yellow / 100k Red]
